...
tellraw @a [{"text":"[DEBUG/FORMAT_CONFIG] ","color":"dark_gray"},{"text":"PROFILE_ID RespawnTime DeliveryTime NetCooldown SplitChance StartCellCount DC_Exp DC_Lin DC_Const MinDeliveryCount SandwichCarryLimit RequiredNutrients"}]
