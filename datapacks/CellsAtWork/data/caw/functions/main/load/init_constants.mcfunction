...
execute unless score $GLOBAL_RESPAWN_SECONDS respawnCountdown matches 0..2147483647 run scoreboard players set $GLOBAL_RESPAWN_SECONDS respawnCountdown 5
