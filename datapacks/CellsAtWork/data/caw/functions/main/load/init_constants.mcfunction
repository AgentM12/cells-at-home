...
execute unless score $Cells_Target target_progress matches 0.. run scoreboard players set $Cells_Target target_progress 30
execute unless score $Pathogens_Target target_progress matches 0.. run scoreboard players set $Pathogens_Target target_progress 15
...
execute unless score $Start_Count cell_count matches 1.. run scoreboard players set $Start_Count cell_count 15
...
execute unless score $Minimum poison_count matches 1.. run scoreboard players set $Minimum poison_count 2
...
execute unless score $GLOBAL_SETTING split_rng_bound matches 1.. run scoreboard players set $GLOBAL_SETTING split_rng_bound 25
