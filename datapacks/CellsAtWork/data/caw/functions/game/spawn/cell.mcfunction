# Teleports cells to the spawn location (if disallow_multiple_spawns is set, marks targets that are used.)
tag @e[type=armor_stand,tag=sl_cell_marker,tag=!sl_used,sort=random,limit=1] add sl_target
