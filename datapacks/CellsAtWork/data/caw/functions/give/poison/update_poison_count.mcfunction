...
execute as @a[tag=pathogen,tag=!should_have_poison,tag=!respawning] run title @s actionbar ["",{"score":{"name":"$poison_count","objective":"poison_count"}},{"text":" nutrients required for next poison"}]
